...
return {
  ...
  { mode = 'n', key = '<leader>wl', act = require('telescope').extensions.projects.projects, desc = '[l]ist' },
  -- TODO: small tricche ballacche
  { mode = 'n', key = '<leader>th',          act = builtin.help_tags, desc = '[h]elp tags' },
  -- { mode = 'c', key = 'h',          act = builtin.help_tags, desc = '[h]elp tags' },
}
