...
_G.packer_plugins = {
  ...
  ["fidget.nvim"] = {
    ...
    loaded = true,
    path = "/home/segandrea/.local/share/nvim/site/pack/packer/start/fidget.nvim",
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'markdown-preview.nvim', 'mkdnflow.nvim', 'mdeval.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
