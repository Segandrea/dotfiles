...
_G.packer_plugins = {
  ...
  ["cmp-latex-symbols"] = {
    loaded = true,
    path = "/home/segandrea/.local/share/nvim/site/pack/packer/start/cmp-latex-symbols",
  ...
  neorg = {
    config = { "\27LJ\2\n)\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\14sgn.neorg\frequire\0" },
    load_after = {},
    loaded = false,
    needs_bufread = true,
    only_cond = false,
    path = "/home/segandrea/.local/share/nvim/site/pack/packer/opt/neorg",
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'mdeval.nvim', 'markdown-preview.nvim', 'mkdnflow.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
time([[Defining lazy-load filetype autocommands]], false)
vim.cmd("augroup END")
vim.cmd [[augroup filetypedetect]]
time([[Sourcing ftdetect script at: /home/segandrea/.local/share/nvim/site/pack/packer/opt/neorg/ftdetect/norg.vim]], true)
vim.cmd [[source /home/segandrea/.local/share/nvim/site/pack/packer/opt/neorg/ftdetect/norg.vim]]
time([[Sourcing ftdetect script at: /home/segandrea/.local/share/nvim/site/pack/packer/opt/neorg/ftdetect/norg.vim]], false)
vim.cmd("augroup END")
